  ...
  return (
    <div style={{maxWidth:680,margin:"0 auto"}}>
      <div style={{marginBottom:20}}>
        <div style={{fontFamily:"'Space Mono',monospace",fontSize:11,letterSpacing:"0.2em",color:"rgba(255,255,255,0.58)",marginBottom:6}}>KNOWLEDGE-WEIGHTED GLICKO-2 · CROWDSOURCED CONSENSUS</div>
        <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:22,fontWeight:700,color:"#e8f4ff",marginBottom:6}}>Planet Priority Index</div>
        <div style={{fontFamily:"'Crimson Pro',serif",fontSize:15,color:"rgba(255,255,255,0.62)",fontStyle:"italic"}}>Habitability scores are hidden from voters. Rankings emerge from blind inference.</div>
      </div>
      ...
      {sorted.map((p,i)=>{
        ...
        return (
          <div key={p.id} onClick={()=>onViewDetail(p)}
            ...
            <div style={{textAlign:"center",fontFamily:"'Orbitron',sans-serif",fontSize:i<3?18:14,fontWeight:700,
            ...
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div>
                <div style={{display:"flex",alignItems:"center",gap:6}}>
                  <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:13,fontWeight:700,color:"#e8f4ff"}}>{p.name}</div>
                  {isRecent && <div style={{fontFamily:"'Space Mono',monospace",fontSize:9,color:c.accent,letterSpacing:"0.08em"}}>JUST VOTED</div>}
                </div>
                <div style={{fontFamily:"'Space Mono',monospace",fontSize:11,color:"rgba(255,255,255,0.62)"}}>{p.type} · {p.host}</div>
              </div>
            </div>
            <div style={{textAlign:"right"}}>
              <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:17,fontWeight:700,color:c.accent}}>{p.r||1500}</div>
              <div style={{display:"flex",alignItems:"center",gap:5,justifyContent:"flex-end",marginTop:2}}>
                ...
                <div style={{fontFamily:"'Space Mono',monospace",fontSize:9,color:"rgba(255,255,255,0.5)"}}>{p.matchups||0}v</div>
              </div>
            </div>
          </div>
        );
